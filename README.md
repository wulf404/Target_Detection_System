...
Общее состояние зеленое `OK` только когда видны и дают свежие данные все нужные
узлы: CAN, камера, башня, дальномер и внешний UART. Наличие цели при этом не
обязательно: система может быть полностью исправна, но цель отсутствует.
...
- центр кадра;
- прямоугольник мертвой зоны из `AutoTracker`;
